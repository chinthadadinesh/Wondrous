...
class Dashboard extends React.Component {
 ...
 getuservotes() {
    fetch("/api/getuservotes/"+localStorage.getItem("id"), {
      method: "get",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/x-www-form-urlencoded"
  ...
  addvote(id) {
    fetch("/api/addvote/"+id+"/"+localStorage.getItem("id"), {
      method: "get",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/x-www-form-urlencoded"
            ...
            <GridContainer>
              <GridItem>
                <div className={classes.brand}>
                  <h1 className={classes.title} style={{marginTop:'-50px'}}>Wondrous</h1>
        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div style={{ padding: '10px' }}>
            <div>
              ...
              <CustomInput
                labelText="Search For Restaurant,Food..."
                id="first"
                name="search"
            ...
            this.state.posts.map((post) => (
              <Card className={classes.card}>
                ...
                <CardActions className={classes.actions} disableActionSpacing>
                  {this.state.votes.includes(post.postId)?( <a >
                    <IconButton aria-label="Add to favorites" >
                      <FavoriteIcon  style={{fontColor:'red',color:'red'}}/>
                    </IconButton>
                  </a>):( <a onClick={() => this.addvote(post.postId)}>
                    <IconButton aria-label="Add to favorites" >
                      <FavoriteIcon />
                    </IconButton>
                  </a>)}
